...
const TTS_BACKEND_FIELDS = {
  ...
  'mimo-voiceclone': [
    { key: 'reference_audio', label: () => t('char.voice_ref_audio') || '参考音频', placeholder: '/path/to/ref.wav' },
    { key: 'aux_ref_audio_paths', label: () => t('char.voice_aux_refs') || '辅助参考音频', type: 'textarea', placeholder: '每行一个路径，用于多说话人音色融合' },
  ],
  'gpt-sovits': [
    { key: 'reference_audio', label: () => t('char.voice_ref_audio') || '参考音频', placeholder: '/path/to/ref.wav' },
    { key: 'aux_ref_audio_paths', label: () => t('char.voice_aux_refs') || '辅助参考音频', type: 'textarea', placeholder: '每行一个路径，用于多说话人音色融合' },
    { key: 'prompt_text', label: () => t('char.voice_prompt_text'), placeholder: '参考音频对应的文本内容' },
    { key: 'prompt_lang', label: () => t('char.voice_prompt_lang'), placeholder: 'zh（默认同语音语言）' },
    { key: 'speed_factor', label: () => t('char.voice_speed'), placeholder: '1.0（0.5=慢速, 2.0=快速）' },
  ],
  'cosyvoice': [
    { key: 'speaker', label: () => t('char.voice_speaker'), placeholder: 'default' },
  ],
  'fish-speech': [
    { key: 'reference_id', label: () => t('char.voice_ref_id') },
  ],
  'chattts': [
    { key: 'voice', label: () => t('char.voice_seed'), type: 'select', options: [
      {v:'1031',l:'1031 — 🧔 低沉男声，沉稳浑厚'},
      {v:'13',l:'13 — 🧔 低沉男声，沙哑沧桑'},
      {v:'5600',l:'5600 — 🧔 温暖男声，自然磁性'},
      {v:'4444',l:'4444 — 🧔 低沉男声，厚实稳重'},
      {v:'2279',l:'2279 — 🧔 温暖男声，柔和低沉'},
      {v:'1983',l:'1983 — 🧔 温暖男声，醇厚自然'},
      {v:'4751',l:'4751 — 🧔 温暖男声，圆润饱满'},
      {v:'14',l:'14 — 🧔 温暖男声，简洁利落'},
      {v:'1579',l:'1579 — 🧔 温暖男声，平静从容'},
      {v:'2222',l:'2222 — 🧔 温暖男声，经典中性'},
      {v:'99999',l:'99999 — 🧔 温暖男声，略带沙哑'},
      {v:'4785',l:'4785 — 🧑 中性偏柔，温和自然'},
      {v:'492',l:'492 — 🧑 中性偏柔，平静舒缓'},
      {v:'16',l:'16 — 🧑 中性偏柔，低沉内敛'},
      {v:'7869',l:'7869 — 🧑 中性偏柔，清澈明亮'},
      {v:'5',l:'5 — 🧑 中性声线，自然流畅'},
      {v:'9999',l:'9999 — 🧑 中性声线，温和稳重'},
      {v:'6653',l:'6653 — 🧑 中性声线，柔和清晰'},
      {v:'4099',l:'4099 — 🧑 中性声线，明亮自然'},
      {v:'2328',l:'2328 — 🧑 中性声线，圆润清脆'},
      {v:'491',l:'491 — 🧑 中性声线，温和亲切'},
      {v:'5555',l:'5555 — 👩 清亮女声，甜美自然'},
      {v:'1455',l:'1455 — 👩 清亮女声，明亮清晰'},
      {v:'1518',l:'1518 — 👩 清亮女声，活泼明快'},
      {v:'6666',l:'6666 — 👩 清亮女声，清脆悦耳'},
      {v:'2345',l:'2345 — 👩 清亮女声，柔和舒缓'},
      {v:'12345',l:'12345 — 👩 清亮女声，自然流畅'},
      {v:'11',l:'11 — 👩 明亮女声，简洁清脆'},
      {v:'5099',l:'5099 — 👩 明亮女声，高亢清晰'},
      {v:'125',l:'125 — 👩 明亮女声，活泼灵动'},
      {v:'1234',l:'1234 — 👩 明亮女声，清亮甜美'},
      {v:'8888',l:'8888 — 👩 明亮女声，明快活泼'},
      {v:'7777',l:'7777 — 👩 明亮女声，高亢有力'},
      {v:'1111',l:'1111 — 👩 明亮女声，清脆激昂'},
      {v:'3333',l:'3333 — 👩 高亮女声，尖锐明亮'},
      {v:'5400',l:'5400 — 👩 高亮女声，高亢激昂'},
      {v:'12',l:'12 — 👩 高亮女声，极高亢'},
    ]},
    { key: 'clone_seed', label: () => t('char.voice_clone_seed'), placeholder: '0=用上方选择, >0覆盖' },
    { key: 'prompt', label: () => t('char.voice_prompt'), placeholder: '[oral_2][laugh_0]' },
  ],
};
