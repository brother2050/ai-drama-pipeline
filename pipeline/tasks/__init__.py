...
# 定妆照 / 场景图
from pipeline.tasks.portrait_tasks import (
...
# TTS / 配乐 / 字幕 / 后期
from pipeline.tasks.media_tasks import (
    post_task, tts_single_task, music_task, subtitle_task,
)

# 训练 / 导入
from pipeline.tasks.training_tasks import train_lora_task, import_json_task
