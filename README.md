...
```
ComfyUI/models/
├── diffusion_models/     # UNet 模型（Flux / Cosmos / HiDream）
...
│   └── backends/                 # 后端实现
│       ├── tts/                  #   TTS: mimo_voicedesign / mimo_voiceclone / gpt_sovits / cosyvoice / fish_speech
...
│       ├── css/style.css         #     样式
│       ├── js/                   #     JS 模块（14 个：core/app/i18n/dashboard/characters/scenes/storyboard/pipeline/projects/tasks/settings/ai-gen/seko/extras）
│       └── favicon.svg
│
├── scripts/                      # 工具脚本
