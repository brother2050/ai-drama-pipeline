...
PLAN_JSON = {
    ...
    "shots": [
        {
            "episode": "1", "shot_id": "001", "scene_id": "living_room", "characters": "linxia",
...
def test_error_cases():
    ...
    plan = ImportPlan(
        ...
        shots=[{"shot_id": "001", "scene_id": "room", "characters": "guchen", "action": "顾辰坐在椅子上看书"}]
    )
    errors = ImportValidator.validate_references(plan)
    ...
    plan2 = ImportPlan(
        ...
        shots=[
            {"shot_id": "001", "scene_id": "s", "characters": "a", "action": "角色在场景中做某个动作"},
            {"shot_id": "001", "scene_id": "s", "characters": "a", "action": "角色在场景中做另一个动作"}
        ]
    )
    ...
    try:
        ImportPlan(project_name="test", shots=[
            {"shot_id": "001", "scene_id": "s", "action": "一个足够长的动作描述", "duration": "15"}
        ])
